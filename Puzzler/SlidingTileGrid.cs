            ...
            if (animateMovement)
            {
                var movementAnimation = new Animation
                {
                    // Animate the X
                    {
                        0,
                        1,
                        new Animation(x =>{matchingTile.CurrentPosition = new PointF((float)x, matchingTile.CurrentPosition.Y);},
                        oldPosition.X,
                        newPosition.X)
                    },
                    ...
                    // Animate the Y
                    {
                        0,
                        1,
                        new Animation(y =>{matchingTile.CurrentPosition = new PointF(matchingTile.CurrentPosition.X, (float)y);this.Invalidate();},
                        oldPosition.Y,
                        newPosition.Y)
                    }
                };
